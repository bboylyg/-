...
def inception_module(in_tensor, c1, c3_1, c3, c5_1, c5, p_c):
    ...
    pool_conv = conv1x1(p_c)(in_tensor)
...
def aux_clf(in_tensor):
    avg_pool = layers.AvgPool2D(pool_size=5, strides=3)(in_tensor)
...
if __name__ == '__main__':
    model = inception_net()
    #plot_model(model, to_file="F://GoogLeNet_plot.png", show_shapes=True, show_layer_names=True)
    print(model.summary())   
